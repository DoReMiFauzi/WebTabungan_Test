...
<form action="{{ route('tabungan.store') }}" method="post" class="container mt-5">
@csrf

  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">Nominal Tabungan</label>
  ...
  <button type="submit" class="btn btn-primary">Tabung</button>
</form>
